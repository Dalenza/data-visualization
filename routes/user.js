...
router.get('/StudentRankClass', (req, res) => {
    ...
    const data = {
        rank: model.getStudentRankClass(name, group, semester)
    };
...
router.get('/StudentRankSection', (req, res) => {
    ...
    const data = {
        rank: model.getStudentRankSection(name, semester)
    };
    res.status(200).send(data);
});
...
router.get('/StudentRankSubjectsClass', (req, res) => {
    ...
    const data = model.getStudentRankSubjectsClass(name, group);
    res.status(200).send(data);
...
router.get('/StudentRankSubjectsSection', (req, res) => {
    ...
    const data = model.getStudentRankSubjectsSection(name);
    res.status(200).send(data);
